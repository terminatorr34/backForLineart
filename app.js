                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td class="logo" style="text-align: center;">
                        <h1><a href="#">Thank you for request</a></h1>
                      </td>
                    </tr>
                  </table>
                </td>
                    ...
                    <tr>
                      <td>
                        <div class="text" style="padding: 0 3em; text-align: center;">
                          <h2>We Are Lineart, We Create <span>Functional</span> &amp; <span>Beautiful</span> Houses</h2>
                        </div>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td class="bg_white email-section">
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" padding-bottom="20px">
                          <tr>
                              ...
                              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                ...
                                <tr>
                                  <td style="padding-top: 20px; padding-right: 10px;">
                                    ...
                                    <div class="text-project" style="text-align: center;">
                                      <h3><a href="#">mail</a></h3>
                                      <span>${req.body.mail}</span>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                  <td style="padding-top: 20px; padding-top: 20px; padding-bottom: 20px;">
                                    ...
                                    <div class="text-project" style="text-align: center;">
                                      ...
                                      <span style="margin-bottom: 20px">${req.body.inputTextArea}</span>
                                    </div>
                                  </td>
                                </tr>
                              </table>
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
              <tr>
                <td valign="middle" class="bg_black footer email-section">
                  <table>
                    <tr>
                      <td valign="top" width="33.333%" style="padding-top: 20px;margin-top: 20px; ">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                          <tr>
                    ...
                    <tr>
                      <td valign="top" width="33.333%">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                          <tr>
                            <td style="text-align: left; padding-right: 10px;">
                              <p>&copy; 2022 Agency. All Rights Reserved</p>
                            </td>
                          </tr>
                        </table>
                      </td>
